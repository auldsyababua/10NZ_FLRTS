...
## 2. System Architecture<!-- {"fold":true} -->
...
## 4. User Roles, Permissions, and Access Control<!-- {"fold":true} -->
...
## 5. User Interface (UI) and User Experience (UX) Design<!-- {"fold":true} -->
...
## 6. LLM Integration & Prompting<!-- {"fold":true} -->
...
## ## 7. Todoist Integration Details<!-- {"fold":true} -->
...
## 8. Other Key Functionalities / Features (MVP)<!-- {"fold":true} -->
...
* **Fields:**
  ...
  * *Note:* We will need to ensure the successful creation of the SOP_Document_Link is also covered by a safety net, possibly by expanding this flag or adding another like Initial_Site_Setup_Completed_by_App. We can detail this in SDD Section 8.1.
...
* **Fields:**
  ...
  * *Airtable Field Type Notes:* Default value for new records is TRUE.
  ### 12 Default_Employee_Lists_Created (Checkbox, Default: FALSE)
...
* **Fields:**
  ### 1 PartnerID_PK (Primary Key - Airtable Autonumber)
  ...
  * *Airtable Field Type Notes:* Airtable Attachment type, allows multiple files.
  ### 5 ContactPerson_FirstName (Single Line Text, Optional)
  * *Description:* First name of the primary contact person at the partner organization.
  ### 6 ContactPerson_LastName (Single Line Text, Optional)
  ...
  * *Airtable Field Type Notes:* Formula field. Example formula: IF(Address_Street1, Address_Street1 & "\n", "") & IF(Address_Street2, Address_Street2 & "\n", "") & IF(Address_City, Address_City & ", ", "") & IF(Address_State, Address_State & " ", "") & IF(Address_Zip, Address_Zip, "") (This formula handles optional fields gracefully).
