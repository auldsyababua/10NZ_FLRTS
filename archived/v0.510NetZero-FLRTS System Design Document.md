...
## 3. Data Model (Airtable)<!-- {"fold":true} -->
...
## 9. Development Phases<!-- {"fold":true} -->
...
* Go over the entire design:
  ...
  * Do I need to set up any development environments?
